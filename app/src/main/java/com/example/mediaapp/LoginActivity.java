...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            // If action bar is still null, log a message or handle it accordingly
            Log.e("LoginActivity", "Action bar is null");
            // Alternatively, you can use a Toolbar as a replacement for the action bar
        }
        ...
        reocverpass = findViewById(R.id.forget);
